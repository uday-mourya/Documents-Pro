     ...
     if (hasRecords) {
      ...
      <div class="card mt-4 ">
        ...
        <div class="card-body text-center">
          <h6 class="card-title"><%= record.get(3) %></h6>
          <p class="card-text text-secondary"><%= record.get(1) %></p>
          <p class="card-text text-secondary"><%= record.get(2) %></p>
                            ...
                            <div class="col-12 mt-4">
                                <div class="card">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text text-secondary"><%= record.get(1) %></p>
                                        <p class="card-text text-secondary"><%= record.get(2) %></p>
                                        <a href="#" class="btn btn-danger text-left">Add to cart</a>
                                        <a href="#" class="btn btn-danger text-right">Buy</a>
                                    </div>
                                </div>
                            </div>
                            <% } %>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card" style="width: 18rem;">
                            <img class="card-img-top" src="images/product1.webp" alt="Card image cap">
                            <div class="card-body">
                                <h6 class="card-title"><%= record.get(3) %></h6>
                                <p class="card-text text-secondary"><%= record.get(1) %></p>
                                <p class="card-text text-secondary"><%= record.get(2) %></p>
                                <a href="#" class="btn btn-danger text-left">Add to cart</a>
                                <a href="#" class="btn btn-danger text-right">Buy</a>                            </div>
                        </div>
                                 <% } %>
                    </div>
                </div> 
