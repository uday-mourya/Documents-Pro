            ...
            <div class="col-md-6">
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-6"><input type="text" class="form-control"  name="name" readonly value="<%= id %>"></div>
                    </div>
                    <div class="row mt-2">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-6"><input type="text" class="form-control"  name="name"readonly value="<%= address %>"></div>
                    </div>
<!--                    <div class="mt-5 text-right"><button class="btn btn-primary profile-button" type="button">Save Profile</button></div>-->
                    <div class="row mt-5">
                            <div class="col-md-4"><a  onclick="return confirmEdit2();" href="Useredit.jsp" ><h6>Edit Profile</h6></a></div>
                            <div class="col-md-4"><a  onclick="return confirmEdit();" href="Userpassupdate.jsp" ><h6>Update Password</h6></a></div>
