 ...
 * @author dell
 */
public class login1111 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(login1111.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
