...
public class Power extends Frame implements WindowListener,ActionListener{
    Label lb1,lb2,lb3,lb4;
    TextField txf,txf2;
    Button bt1,bt2;
    public Power(){
        this.setVisible(true);
        this.setBounds(100, 80, 500, 380);
        this.setTitle("Power");
        this.addWindowListener(this);
        this.setBackground(Color.lightGray);

        this.setLayout(null);
        lb1=new Label(" Enter Base : ");
        lb1.setBounds(70, 60, 90, 30);
        lb1.setBackground(Color.white);
        this.add(lb1);

        this.setLayout(null);
        lb1=new Label(" Enter Power :");
        lb1.setBounds(70, 120, 90, 30);
        lb1.setBackground(Color.white);
        this.add(lb1);
        ...
        lb3.setBounds(70,180,90,30);
        this.add(lb3);

        bt1=new Button("Sumbit");
        bt1.setBounds(70,240,90,30);
        bt1.setBackground(Color.white);
        this.add(bt1);

        bt2=new Button("Clear");
        bt2.setBounds(200,240,90,30);
        bt2.setBackground(Color.white);
        this.add(bt2);

        lb2=new Label();
        lb2.setBounds(200, 180, 90, 30);
