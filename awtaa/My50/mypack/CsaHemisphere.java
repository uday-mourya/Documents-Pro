...
public class CsaHemisphere extends Frame implements WindowListener,ActionListener
{
    Label l1,l2,l3;
    TextField tf1,tf2,tf3;
    Button b1,b2,b3;
    public CsaHemisphere()
    {
        this.setVisible(true);
        
        this.setTitle("CSAHemisphere");
