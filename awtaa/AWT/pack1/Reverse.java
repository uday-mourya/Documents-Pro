...
public class Reverse extends Frame implements WindowListener,ActionListener{
    Label lb1,lb2,lb3;
    TextField txf;
    Button bt1,bt2;
    public Reverse(){
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==bt1){
            ...
            lb2.setText(String.valueOf(rev));
        }
