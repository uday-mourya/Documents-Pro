 ...
 * @author dell
 */
public class Dashboardnew2 extends javax.swing.JFrame {

    /**
     * Creates new form Dashboardnew
     */
    public Dashboardnew2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        name11.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                name11KeyTyped(evt);
            }
        });
        ...
        combo1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Btech", "Bca" }));

        combo2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CSE", "Electrical", "It", "Bca", " " }));

        combo3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "male", "female", "other" }));
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(name11, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                            .addComponent(combo1, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                            .addComponent(fname, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE)))
                                    .addComponent(combo2, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(combo3, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel5Layout.createSequentialGroup()
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGap(26, 26, 26)
                        .addComponent(name11, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(22, 22, 22)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(combo2, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(38, 38, 38)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                    ...
                                    .addGap(142, 142, 142))
                                .addComponent(jLabel6, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 507, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
//        if(roll.getText().equals("")||name1.getText().equals("")||fathername.getText().equals(""))
//        {
//           JOptionPane.showMessageDialog(null, "Please Sari fiels enter karo nahi to");
//        }
//        else{
                ...
                try{
                          ...
                          String name=name11.getText();
                          String faname=fname.getText();
                          String course1=(String)combo1.getSelectedItem();
                          String branch2=(String)combo2.getSelectedItem();
                          String gender3=(String)combo3.getSelectedItem();
                        ...
                        String sql="insert into details(rollno,name,fathername,course,branch,gender) values(?,?,?,?,?,?)";
                        PreparedStatement ps = con.prepareStatement(sql);
                         //Statement st=con.createStatement();
                        //st.executeUpdate("insert into details (rollno,name,fname) value('"+rollno+"','"+Name+"','"+Fname+"','"+course+"','"+branch+"','"+gender+"')");
                        //st.executeUpdate("insert into details(rollno,name,fname) values('"+rollno+"','"+Name+"','"+Fname+"')");
                        ps.setString(1, rollno);
                        ps.setString(2,name);
                        ps.setString(3, faname);
                        ps.setString(4,course1);
                        ps.setString(5, branch2);
                        ps.setString(6,gender3);
    ...
    private void name11KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_name11KeyTyped
        // TODO add your handling code here:
        char c = evt.getKeyChar();
        if (Character.isDigit(c)) {
            evt.consume();
        }
    }//GEN-LAST:event_name11KeyTyped
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Dashboardnew2().setVisible(true);
            }
        });
    }
