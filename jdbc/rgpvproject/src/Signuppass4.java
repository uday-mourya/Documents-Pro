 ...
 * @author dell
 */
public class Signuppass4 extends javax.swing.JFrame {
...
//    }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if(un.getText().equals("")||pass.getText().equals("")||pass3.getText().equals("")){
            ...
            if(pass.getText().equals(pass3.getText())){
                    ...
                    try{
                        ...
                        String sql="insert into adminlogin1 values(?,?)";
...
//        dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Signuppass4().setVisible(true);
            }
        });
    }
