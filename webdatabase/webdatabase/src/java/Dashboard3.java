...
//                String  mobile = (String)session.getAttribute(" mobile");
        ...
        out.print("                    <div id='myoption'><span id='text1'>User Name :&nbsp;&nbsp;"+rs1.getString(1)+"</span></div>");
        out.print("                    <div id='myoption'><span id='text1'>Email-id :&nbsp;&nbsp;"+rs1.getString(3)+"</span></div>");
        out.print("                    <div id='myoption'><span id='text1'>Mobile no :&nbsp;&nbsp;"+rs1.getString(5)+"</span></div>");
        out.print("                  <div id='myoption'><span id='text1'>Password :&nbsp;&nbsp;********</span></div>");
