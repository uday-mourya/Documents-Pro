...
public class PasswordUpdate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(oldpass.equals(udao.getPassword())){ 
            if(newpass.equals(confpass)){
           
            udao.setPassword(newpass);
            UserDTO udto=new UserDTO();
            try {
                boolean b=udto.passwordUpdate(udao);
                if(b){
                ...
                Logger.getLogger(PasswordUpdate.class.getName()).log(Level.SEVERE, null, ex);
            }
